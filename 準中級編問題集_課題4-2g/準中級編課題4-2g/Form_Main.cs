...
namespace 準中級編課題4_2g
{
    ...
    public partial class Form_Main : Form
    {
        ...
        /// <summary>
        /// ボタンを押したら、DBからデータを読み込み、
        /// リストビューに3科目の合計点も含めてデータを表示する
            ...
            try
            {
                ...
                string sqlCommand = @"
                                SELECT
                                    ...
                                    R.MATHEMATICS_POINT,
                                    R.ENGLISH_POINT,
                                    R.JAPANESE_POINT + R.MATHEMATICS_POINT + R.ENGLISH_POINT AS TOTAL
                                FROM RESULT_TABLE AS R
                                JOIN STUDENT_TABLE AS S ON R.STUDENT_ID = S.STUDENT_ID
                                ORDER BY TOTAL DESC
                                ;";
