...
namespace 準中級編課題4_4b
{
    public partial class Form_Main : Form
    {
        ...
        /// <summary>
        /// Mainフォームを起動したら、リストビューにテーブルデータを表示
        /// </summary>
        ...
        /// <summary>
        /// ボタンを押したら、Manegementフォームを表示する
        /// Manegementフォームの閉じるボタンが押されたら、
        /// Mainフォームのリストビューの表示を更新する
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void button_StudentManegement_Click(object sender, EventArgs e)
        {
            // Manegementフォームを開く
            Form_Management form_Magement = new Form_Management();
            DialogResult dr = new DialogResult();

            dr = form_Magement.ShowDialog();

            // Manegementフォームの閉じるボタンが押されたとき以外
        ...
        /// RegistフォームのOKボタンが押されたら、RESULTテーブルにデータを追加
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void button_Regist_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string index = form_Regist.ScoreRegist.StudentID;
        ...
        /// <summary>
        /// ボタンを押したら、Updateフォームを表示する
        /// UpdateフォームのOKボタンが押されたら、RESULTテーブルのデータを更新する
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void listFromTableData()
        {
            ...
            try
            {
                ...
                // RESULTテーブルとSTUDENTテーブルを同じSTUDENT_IDで結合する
                com.CommandText = @"SELECT * FROM RESULT_TABLE AS R JOIN STUDENT_TABLE AS S
